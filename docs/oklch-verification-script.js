...
console.log(
  "✅ OKLCH Support:",
  oklchSupported ? "Supported" : "Not supported"
);
...
console.log(
  supportsP3 ? "✅" : "⚪",
  "P3 (Wide gamut):",
  supportsP3 ? "Supported" : "Not supported"
);
console.log(
  supportsRec2020 ? "✅" : "⚪",
  "Rec2020 (Ultra wide):",
  supportsRec2020 ? "Supported" : "Not supported"
);
...
const testColors = [
  {
    name: "Primary Blue",
    oklch: "oklch(0.6018 0.1619 255.9988)",
    expected: "Rich blue",
  },
  {
    name: "Chart Cyan",
    oklch: "oklch(0.6925 0.1686 142.4955)",
    expected: "Vibrant cyan",
  },
  {
    name: "Chart Green",
    oklch: "oklch(0.7441 0.1372 121.5518)",
    expected: "Fresh green",
  },
  {
    name: "Chart Yellow",
    oklch: "oklch(0.7921 0.1696 92.2054)",
    expected: "Warm yellow",
  },
];
...
console.log(
  "✅ Theme switching:",
  lightBg !== darkBg ? "Working" : "Issues detected"
);
...
for (let i = 0; i < 1000; i++) {
  ...
  div.style.backgroundColor = `oklch(0.${Math.floor(
    Math.random() * 9
  )} 0.1 ${Math.floor(Math.random() * 360)})`;
...
console.log(
  "✅ Performance test:",
  `${(endTime - startTime).toFixed(2)}ms for 1000 OKLCH operations`
);
