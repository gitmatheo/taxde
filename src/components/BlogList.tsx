...
const BlogList = ({ onPostClick }: BlogListProps) => {
  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      excerpt: 'Przegląd najważniejszych zmian w prawie podatkowym, które wchodzą w życie w 2024 roku i ich wpływ na prowadzenie działalności gospodarczej.',
    ...
    },
    {
      ...
      excerpt: 'Jak przejść na cyfrową księgowość krok po kroku. Praktyczne wskazówki i najlepsze praktyki dla małych i średnich firm.',
      category: 'Cyfryzacja',
    ...
    },
    {
      ...
      excerpt: 'Poznaj legalne metody optymalizacji podatkowej, które mogą znacząco obniżyć obciążenia podatkowe Twojej firmy.',
    ...
    },
    {
      ...
      excerpt: 'Kompletny przewodnik po jednolitym pliku kontrolnym VAT. Terminy, wymagania i praktyczne wskazówki.',
      category: 'VAT',
      date: '8 grudnia 2024',
      readTime: '4 min',
    ...
    },
    {
      ...
      excerpt: 'Przegląd najważniejszych zmian w obszarze kadr i płac, które obowiązują od 2024 roku.',
    ...
    },
    {
      ...
      excerpt: 'Analiza zwrotu z inwestycji w automatyzację księgowości i konkretne korzyści dla biznesu.',
  ...
  const categories = ['Wszystkie', 'Prawo podatkowe', 'Cyfryzacja', 'Optymalizacja', 'VAT', 'Kadry i płace', 'Automatyzacja'];
